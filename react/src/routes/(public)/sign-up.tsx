        ...
        <div className="flex p-4 h-screen">
            ...
            <div className="flex-1 grid place-items-center">
                <div className="max-w-md m-auto w-full">
                    ...
                    <p className="text-muted-foreground mb-8">Enter your personal data to create your account</p>
                    ...
                    <p className="text-center my-4 text-sm">
                        ...
                        <Link className="text-blue-600 hover:underline ml-2" to="/sign-in">Sign in</Link>
                    </p>
